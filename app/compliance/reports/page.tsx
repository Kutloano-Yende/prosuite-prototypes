  ...
  const [reports] = useState<Report[]>([
    {
      ...
      type: 'Status',
      description: 'Overview of compliance status across all obligations and regulations',
    ...
    },
    {
      ...
      type: 'Assessment',
      description: 'Summary of recent compliance assessment results and findings',
    ...
    },
    {
      ...
      type: 'Progress',
      description: 'Progress tracking for all active compliance action plans',
    ...
    },
    {
      ...
      type: 'Analysis',
      description: 'Analysis of new regulations and their impact on compliance obligations',
    ...
    },
    {
      ...
      type: 'Dashboard',
      description: 'High-level compliance metrics and KPIs for executive reporting',
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Generate and manage compliance reports and analytics</p>
          </div>
          ...
          <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Current compliance overview</p>
              </div>
            </div>
          </button>
          <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Latest assessment findings</p>
              </div>
            </div>
          </button>
          <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-900">Action Plan Progress</h3>
                <p className="text-xs text-gray-500">Remediation progress tracking</p>
              </div>
            </div>
          </button>
          <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">High-level compliance metrics</p>
              </div>
            </div>
          </button>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {reports.map((report) => (
                <tr key={report.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getFrequencyColor(report.frequency)}`}>
                      {report.frequency}
                    </span>
                  </td>
      ...
      <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <p className="text-xs text-gray-500 mb-3">Visual compliance metrics and trends</p>
            <button className="text-xs text-green-600 hover:text-green-800">Use Template</button>
          </div>
          <div className="p-4 border border-gray-200 rounded-lg">
            <h3 className="text-sm font-medium text-gray-900 mb-2">Regulatory Report</h3>
            <p className="text-xs text-gray-500 mb-3">Detailed regulatory compliance analysis</p>
            <button className="text-xs text-green-600 hover:text-green-800">Use Template</button>
          </div>
          <div className="p-4 border border-gray-200 rounded-lg">
            <h3 className="text-sm font-medium text-gray-900 mb-2">Audit Report</h3>
            <p className="text-xs text-gray-500 mb-3">Comprehensive audit findings and recommendations</p>
            <button className="text-xs text-green-600 hover:text-green-800">Use Template</button>
          </div>
        </div>
      </div>
